$(document).on('click', ".btn-DetalleVerif", function(e) {
    //alert("Aqui se actiav el evento form datos usuario");
    var iddetverif = $(this).attr("id_verifdet");
...
$(".cierradetalle").click(function(){
    ...
    var element = document.getElementById("basicModal2"); 
    if (element) element.click();


  });

  $(".cierramodif").click(function(){
    //$("#basicModal2").modal('hide')
